        ...
        <ul class="siderbar">
        	...
        	<li><span>人员信息管理</span>
	        	<ul>
	               ...
	               <li><a href="<%=path %>/Admin/RoleAdd.jsp" target="mainFrame">添加职位信息</a></li>
	               <li><a href="<%=path %>/RoleHandle?type=4" target="mainFrame">管理职位信息</a></li>
	        ...
	        <li><span>IC卡信息管理</span>
	            <ul>
	                <li><a href="<%=path %>/Admin/CardAdd.jsp" target="mainFrame">添加IC卡</a></li>
	                <li><a href="<%=path %>/CardHandle?type=4" target="mainFrame">管理IC卡</a></li>
	            </ul>
	        </li>
	        <li><span>固定车辆管理</span>
	            <ul>
	        ...
	        <li><span>临时车辆管理</span>
	        	<ul>
	                <li><a href="<%=path %>/Admin/TempAdd.jsp" target="mainFrame">添加车主入场信息</a></li>
	                <li><a href="<%=path %>/TempHandle?type=4" target="mainFrame">管理车主出场信息</a></li>
	        	</ul>
            </li>
	        <li><span>系统功能</span>
	        	<ul>
