	...
	<%
	 ...
	 <form action="<%=path %>/RoleHandle?type=2" method="post">
		<table style=" margin:50px auto;">
	            <tbody>
			 <tr><td>编号：</td><td><input type="text" name="role_id" value="<%=obj[0] %>" readonly="readonly" /></td></tr>
 			 <tr><td>姓名：</td><td><input type="text" name="role_name" value="<%=obj[1] %>" required /></td></tr>
		    </tbody>   
